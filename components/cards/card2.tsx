             ...
             <div  className="flex flex-col   h-full  w-full shadow  rounded-lg flex-grow ">
                <div className="w-full flex-[1_0_65%] grid gap-1">
                    <div className="col-start-1 col-end-4 row-span-2">
                        <Image src={data.image} className="object-cover w-full h-full rounded-l-lg rounded-b-[0px]  "/>
                    </div>
                    <div className="col-start-4 col-end-6">
                        <Image src={data.image} className="object-cover w-full h-full rounded-r-lg rounded-b-[0px]"/>
                    </div>
                    <div className="col-start-4 col-end-6">
                        <Image src={data.image} className="object-cover w-full h-full  "/>
                    </div>
                ...
                <div className="w-full p-2  ">
                    <div className="  tablet:h-full gap-2 tablet:grid">
                        ...
                        <div className="flex flex-row  tablet:text-xs gap-1 items-center tablet:col-start-2 tabletcol-end-3">
                            <Image src="/location_icon.svg" className="h-4 w-4 tablet:hidden"/>
