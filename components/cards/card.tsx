...
const CardHome:React.FC<Card>=(props)=>{
    ...
    const video=2
    return(
        <div  className="flex-[1_0_21%]    tablet:w-full h-80 tablet:h-32 tablet:p-0 select-none  rounded-lg">
            <div  className="flex flex-col  tablet:flex-row h-full   w-full shadow  rounded-lg flex-grow ">
                <div className="flex-[1_0_55%] relative tablet:p-2 indicator">
                    <div className="absolute z-[60] bottom-2 left-2 opacity-90">
                ...
                <div className="divide-y w-full flex flex-col justify-between tablet:divide-y-0 p-1 overflow-hidden  flex-[1_0_45%] tablet:flex-[2_1_0%]  tablet:p-2 tablet:px-0 flex flex-col px-2 ">
                    <div className=" cardTitle  tablet:h-full tablet:gap-x-2 tablet:flex-none  tablet:space-y-0 tablet:grid">
                        ...
                        <div className="  flex  w-full mt-3 flex-wrap tablet:text-xs gap-1  tablet:gap-1 tablet:col-start-1 tabletcol-end-2 ">
                        ...
                        <div className="flex flex-row mt-1 tablet:text-xs gap-2 items-center tablet:col-start-2 tabletcol-end-3">
                            <img src="/location_icon.svg" className="h-3 w-3 tablet:hidden"/>
                            <p className="text-xs line-clamp-1"> {data.address}</p>
                        </div>
                    </div>
                    
                    <div className="py-1 tablet:hidden flex justify-between items-center">
