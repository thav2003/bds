    ...
    return (
        <div className="flex flex-row bg-slate-200 ">
            ...
            <div className="w-1/2 p-2 flex">
                <div className="bg-white w-9/12 p-8 shadow shadow-slate-800 rounded">
                    <div className="mb-6">
                        ...
                        <div className="relative">
                            ...
                            />
                             <span className="absolute inset-y-1/2 top-2/3 right-3 flex items-center pl-2 cursor-pointer">
                                <img src="password-hide.svg" className="w-auto h-auto"/>
                            </span>
                        </div>
                    </div>
                    ...
                    <div className="space-y-2">
                        <button type="button" className="inline-flex items-center justify-center mr-2 mb-2 text-center bg-transparent hover:bg-purple-900  border border-blue-500 py-2 px-4 rounded-full w-full">
                        <img src="/facebook.svg" alt="Logo" className="w-auto h-auto mr-2 ml-1 "  />
                        ...
                        <p className="flex justify-center items-center text-sm">Bạn chưa có tài khoản <span className="text-purple-600">Đăng kí ngay</span></p>
                    </div>
