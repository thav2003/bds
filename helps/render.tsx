...
export const RenderPopUp=({  
    classNameInput,data,renderDropLeftIcon,classNameLabel,classNameButton,
    input,
    page,
    label,
    type,
    ...
    return(
      <div className="space-y-1">
        <label className={`font-semibold ${classNameLabel}`}>{label}</label>
        ...
        <button type="button" className={`w-full text-placeholder
                ...
                border border-slate-300 text-left ${change ? 'text-black':'text-slate-400 '} ${classNameButton}`}  onClick={onOpen}
                ...
                <div className=" w-full flex flex-col  space-y-4  ">
                  ...
                  <div className="overflow-y-auto h-[50vh] tablet:h-[100vh] w-full relative bnone">
                      ...
                      <ListGroup>
                        ...
                        {data && data.map((item:any,index:any):any=>{
                          return(
                            <ListGroup.Item key={index} onClick={()=>selectItem(item)}
                            >
                              <div className="py-1">
